      ...
      <header className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between bg-card p-6 md:p-8 rounded-2xl border border-border shadow-sm">
        <div className="flex flex-col gap-4 max-w-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground tracking-tight">Chào các đồng âm, tôi là [Tên Sếp] 👋</h1>
              <p className="text-primary font-medium">[Vị trí / Công việc hiện tại]</p>
            </div>
          </div>
          ...
          <div className="text-muted-foreground leading-relaxed space-y-2">
            ...
            <p>
              [Tiểu sử ngắn hoặc châm ngôn sống của sếp có thể để ở đây. Ví dụ: Đam mê code dạo, thích uống cafe và hay thức khuya fix bug...]
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-2">
            ...
            <a href="https://github.com/[username-cua-sep]" target="_blank" rel="noreferrer" className="px-5 py-2.5 bg-muted text-foreground font-medium rounded-lg hover:bg-muted/80 transition-colors flex items-center gap-2 border border-border">
