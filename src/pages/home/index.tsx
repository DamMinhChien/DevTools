      ...
      <header className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between bg-card p-6 md:p-8 rounded-2xl border border-border shadow-sm">
        <div className="flex flex-col gap-4 max-w-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground tracking-tight">Chào các đồng râm, tôi là Đàm Minh Chiến 👋</h1>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-2">
            ...
            <a href="https://gitlab.com/DamMinhChien" target="_blank" rel="noreferrer" className="px-5 py-2.5 bg-[#FC6D26]/10 text-[#FC6D26] font-medium rounded-lg hover:bg-[#FC6D26]/20 transition-colors flex items-center gap-2 border border-[#FC6D26]/30">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M22.65 14.39L12 22.13 1.35 14.39a.84.84 0 0 1-.3-.94l1.22-3.78 2.44-7.51A.42.42 0 0 1 5.1 2h.02a.43.43 0 0 1 .4.26l2.45 7.51h8.06l2.44-7.51A.43.43 0 0 1 18.88 2h.02a.42.42 0 0 1 .4.16l2.44 7.51 1.22 3.78a.84.84 0 0 1-.31.94z"/></svg>
              GitLab
            </a>
          </div>
        </div>
